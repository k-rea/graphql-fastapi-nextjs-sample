...
def include_object_by_user(object, name, type_, reflected, compare_to):
    include_object(object, name, type_, reflected, compare_to)
...
def run_migrations_offline():
    ...
    context.configure(
        ...
        include_object=include_object_by_user,  # by user
    )
